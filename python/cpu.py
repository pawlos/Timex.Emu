...
class CPU(object):
    ...
    def __init__(self,
        ...
        self.dispatchTable = {
            ...
            # DDCB prefix: dispatch on prefix+operation (displacement-independent)
            0xddcb06: Opcodes.rlc_at_ix_n,
            0xddcb0e: Opcodes.rrc_at_ix_n,
            0xddcb16: Opcodes.rl_at_ix_n,
            0xddcb1e: Opcodes.rr_at_ix_n,
            0xddcb26: Opcodes.sla_at_ix_n,
            0xddcb2e: Opcodes.sra_at_ix_n,
            0xddcb36: Opcodes.sll_at_ix_n,
            0xddcb3e: Opcodes.srl_at_ix_n,
            0xddcb46: Opcodes.bit_bit_ix,
            0xddcb4e: Opcodes.bit_bit_ix,
            0xddcb56: Opcodes.bit_bit_ix,
            0xddcb5e: Opcodes.bit_bit_ix,
            0xddcb66: Opcodes.bit_bit_ix,
            0xddcb6e: Opcodes.bit_bit_ix,
            0xddcb76: Opcodes.bit_bit_ix,
            0xddcb7e: Opcodes.bit_bit_ix,
            0xddcb86: Opcodes.bit_res_ix,
            0xddcb8e: Opcodes.bit_res_ix,
            0xddcb96: Opcodes.bit_res_ix,
            0xddcb9e: Opcodes.bit_res_ix,
            0xddcba6: Opcodes.bit_res_ix,
            0xddcbae: Opcodes.bit_res_ix,
            0xddcbb6: Opcodes.bit_res_ix,
            0xddcbbe: Opcodes.bit_res_ix,
            0xddcbc6: Opcodes.bit_set_ix,
            0xddcbce: Opcodes.bit_set_ix,
            0xddcbd6: Opcodes.bit_set_ix,
            0xddcbde: Opcodes.bit_set_ix,
            0xddcbe6: Opcodes.bit_set_ix,
            0xddcbee: Opcodes.bit_set_ix,
            0xddcbf6: Opcodes.bit_set_ix,
            0xddcbfe: Opcodes.bit_set_ix,
            # FDCB prefix: dispatch on prefix+operation (displacement-independent)
            0xfdcb06: Opcodes.rlc_at_iy_n,
            0xfdcb0e: Opcodes.rrc_at_iy_n,
            0xfdcb16: Opcodes.rl_at_iy_n,
            0xfdcb1e: Opcodes.rr_at_iy_n,
            0xfdcb26: Opcodes.sla_at_iy_n,
            0xfdcb2e: Opcodes.sra_at_iy_n,
            0xfdcb36: Opcodes.sll_at_iy_n,
            0xfdcb3e: Opcodes.srl_at_iy_n,
            0xfdcb46: Opcodes.bit_bit_iy,
            0xfdcb4e: Opcodes.bit_bit_iy,
            0xfdcb56: Opcodes.bit_bit_iy,
            0xfdcb5e: Opcodes.bit_bit_iy,
            0xfdcb66: Opcodes.bit_bit_iy,
            0xfdcb6e: Opcodes.bit_bit_iy,
            0xfdcb76: Opcodes.bit_bit_iy,
            0xfdcb7e: Opcodes.bit_bit_iy,
            0xfdcb86: Opcodes.bit_res_iy,
            0xfdcb8e: Opcodes.bit_res_iy,
            0xfdcb96: Opcodes.bit_res_iy,
            0xfdcb9e: Opcodes.bit_res_iy,
            0xfdcba6: Opcodes.bit_res_iy,
            0xfdcbae: Opcodes.bit_res_iy,
            0xfdcbb6: Opcodes.bit_res_iy,
            0xfdcbbe: Opcodes.bit_res_iy,
            0xfdcbc6: Opcodes.bit_set_iy,
            0xfdcbce: Opcodes.bit_set_iy,
            0xfdcbd6: Opcodes.bit_set_iy,
            0xfdcbde: Opcodes.bit_set_iy,
            0xfdcbe6: Opcodes.bit_set_iy,
            0xfdcbee: Opcodes.bit_set_iy,
            0xfdcbf6: Opcodes.bit_set_iy,
            0xfdcbfe: Opcodes.bit_set_iy
        }
    ...
    def fourBytesOpcodes(self, cpu, opcode, logger):
        ...
        # Dispatch on prefix + operation byte only, stripping displacement
        dispatchKey = (opcode << 8) + fourthbyte
        try:
            _dispatch = self.dispatchTable[dispatchKey]
            if type(_dispatch) is list:
                _dispatch = _dispatch[0]
            self.debugger.next_opcode(pc, self)
            _dispatch(self, fullOpcode, self.logger)
        except KeyError:
            # Fall back to full opcode lookup for backwards compatibility
            self.dispatch(fullOpcode, pc)
