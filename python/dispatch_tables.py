...
def build_dd_table():
    return {
        ...
        0xE1: Opcodes.pop_ix,
        0xE3: Opcodes.ex_sp_ix,
        0xE5: Opcodes.push_ix,
        0xE9: Opcodes.jp_ix,
        0xF9: Opcodes.ld_sp_ix,
    }
...
def build_ed_table():
    return {
        ...
        0x57: Opcodes.ldai,
        0x58: Opcodes.in_r_c,
        0x59: Opcodes.out_c_r,
        0x5A: Opcodes.add_Hl_rr_c,
        0x5B: Opcodes.ld16_nn,
        0x5E: Opcodes.im2,
        0x5F: Opcodes.ldar,
        0x60: Opcodes.in_r_c,
        0x61: Opcodes.out_c_r,
        0x62: Opcodes.sbc,
        0x63: Opcodes.ldNnRr,
        0x65: Opcodes.retn,
        0x67: Opcodes.rrd,
        0x68: Opcodes.in_r_c,
        0x69: Opcodes.out_c_r,
...
def build_fd_table():
    return {
        ...
        0x24: Opcodes.inc_iyh,
        0x25: Opcodes.dec_iyh,
        0x21: Opcodes.ldiy,
        ...
        0x2B: Opcodes.dec_iy,
        0x2C: Opcodes.inc_iyl,
        0x2D: Opcodes.dec_iyl,
        ...
        0xE1: Opcodes.pop_iy,
        0xE3: Opcodes.ex_sp_iy,
        0xE5: Opcodes.push_iy,
        0xE9: Opcodes.jp_iy,
        0xF9: Opcodes.ld_sp_iy,
    }
